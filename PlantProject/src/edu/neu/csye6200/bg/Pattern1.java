...
public class Pattern1 extends BGGenerationSet implements Observable{
	...
	public Pattern1(int maxN) {
		...
		slist1.add(stem);
		/**
		 * The for loop is used for creating the tree with the pattern of each stem to split into 2
		 * maxN - is the total number of levels the tree would grow
		 */
	...
	public ArrayList<Stembg>  Pattern1(int maxN) {
		int angleDeviation=30; // angle deviation from the parent stem 
		int multiplier=5;// for the height ratio of tree
